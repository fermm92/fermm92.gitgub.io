...
Fernando is a transport modeler who leverages large datasets and multiple data sources to gain operational insight on transport networks on the UK. Aiding the build traffic of models and testing future scenarios that will support evidence based decision making for local authorities and major transport agencies. 
