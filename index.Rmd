...
**Part 1** details show to set up a quick classifier model with a RESTful API using plumber and mlr.

**Part 2** shows how, with the help of docker and rocker, we can containeraize our application to be deployed on the cloud to quickly integrate it within our company.
